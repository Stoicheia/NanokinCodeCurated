...
public class Math3d : MonoBehaviour
{
	...
	{
		Profiler.BeginSample("Math3D.ProjectPointOnPlane");
		float   distance;
	...
	//Calculate angle to ground in radians
	public static float AngleToGround(Vector3 planeNormal, Vector3 vector)
	{
		return Mathf.Acos(ProjectVectorOnPlane(planeNormal, vector.normalized).magnitude);
	}
